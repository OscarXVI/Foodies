...
import com.dinosoftlabs.foodies.android.Adapters.RestSpecialityAdapter;
...
public class RestaurantSpecialityFrag extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        searchView.setQueryHint(Html.fromHtml("<font color = #dddddd>" + "Search Restaurant Speciality" + "</font>"));
