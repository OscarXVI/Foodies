...
public class Config {
    ...
    public static String baseURL = "Here is Base url of all the apis listed below";
   public static String imgBaseURL = "Here is Base url of all the images that will show in the app";
