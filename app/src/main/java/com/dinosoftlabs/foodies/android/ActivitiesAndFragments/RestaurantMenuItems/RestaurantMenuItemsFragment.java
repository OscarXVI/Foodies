...
import com.dinosoftlabs.foodies.android.ActivitiesAndFragments.RestaurantDealsFragment;
...
import com.dinosoftlabs.foodies.android.Adapters.RestaurantMenuAdapter;
...
public class RestaurantMenuItemsFragment extends Fragment {
    ...
    public boolean if_list_design=true;

    RelativeLayout list_menu_layout,tab_menu_layout;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        menu_pager.setOffscreenPageLimit(10);
        menu_tab = (TabLayout) view.findViewById(R.id.menu_tab);


        list_menu_layout=view.findViewById(R.id.list_menu_layout);
        tab_menu_layout=view.findViewById(R.id.tab_menu_layout);

        if(if_list_design) {

            list_menu_layout.setVisibility(View.VISIBLE);
            restaurantMenuDetail_for_listview();

        }
       else  {

            tab_menu_layout.setVisibility(View.VISIBLE);
        ...
        suggestion_div.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                 ...
                 if(if_list_design)
                     ...
                     list_menu_layout.setVisibility(View.VISIBLE);
                     tab_menu_layout.setVisibility(View.GONE);
                     restaurantMenuDetail_for_listview();
                 }
        ...
        close_suggestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(if_list_design)
                    ...
                    list_menu_layout.setVisibility(View.GONE);
                    tab_menu_layout.setVisibility(View.VISIBLE);
                    restaurantMenuDetail();
                }
...
// Get the associated LayoutParams and set leftMargin
     ...
     if(delivery_free_range.equalsIgnoreCase("0")){
         miles_desc_tv.setText(symbol + " " + delivery_fee_per_km + " /km");
     }
        else {
         miles_desc_tv.setText(symbol + " " + delivery_fee_per_km + " /km- free delivery over " + symbol + " " + min_order_price + " within " + delivery_free_range + " km");
     }
...
protected ViewPager menu_pager;
 ...
 public void restaurantMenuDetail(){
     ...
     Log.d("JSONPost", Config.SHOW_RESTAURANT_MENU);
                     ...
                     for (int i = 0; i < jsonArray.length(); i++) {
                         ...
                         for (int j =0; j<resMenuArray.length();j++){
                            ...
                            restaurantParentModel.setSub_title(resMenuAllObj.optString("description"));
                             ...
                             adapter.addFrag(new Menu_item_F(listChildData),restaurantParentModel.getTitle());
                         ...
                         menu_tab.setupWithViewPager(menu_pager);
